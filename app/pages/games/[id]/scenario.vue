  ...
  <div class="mb-1 mt-1">
    <div class="flex items-center">
      <BackButton
          ...
          classProp="pl-2"
      />
      <p class="text-2xl font-bold text-gray-900 pl-2">Scenario</p>
      <p class="text-2xl text-gray-600 pl-2">{{ game?.name }}</p>

      <button
          type="submit"
          :disabled="scenarioLoading"
          class="ml-auto mr-1 px-4 py-1 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-50"
      >
